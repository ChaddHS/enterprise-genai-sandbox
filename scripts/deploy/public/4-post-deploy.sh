...
az webapp cors add -g  "rg-${RG}" -n "app-${unquie_name}-webapi" --allowed-origins "https://${swa_hostname}" "https://chatkna.kaplan.com" "https://app-copichat-fofunnuufhjhk-webapi.azurewebsites.net"
